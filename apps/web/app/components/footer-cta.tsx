...
export function FooterCTA() {
	return (
		<div className="border border-border md:container text-center px-10 py-14 mx-4 md:mx-auto md:px-24 md:py-20 mb-32 mt-24 flex items-center flex-col bg-accent">
			<span className="text-6xl md:text-8xl font-medium text-primary">Your tagline here.</span>
			...
			<div className="mt-10 md:mb-8">
				<div className="flex items-center space-x-4">
					<a href="#contact">
						<Button variant="outline" className="border border-primary h-12 px-6 hidden md:block">
							Talk to us
						</Button>
					</a>
