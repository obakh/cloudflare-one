	...
	return (
		...
		>
			...
			>
				{items.map((item, idx) => (
					<li
						className="w-[310px] max-w-full relative flex-shrink-0 border border-border bg-card px-8 py-6 md:w-[310px]"
						key={item.name + idx}
					>
						<blockquote>
							<div
							...
							<div className="flex space-x-2 items-center mb-6">
								...
								<div className="flex flex-col">
									...
									<span className="text-sm text-muted-foreground font-normal">{item.handle}</span>
								</div>
							</div>
