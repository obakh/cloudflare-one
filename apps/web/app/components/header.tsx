...
const APP_URL = "https://app.monorepo.cc";
const ADMIN_URL = "https://admin.monorepo.cc";
const BLOG_URL = "https://blog.monorepo.cc";
...
export function Header() {
	...
	const links: LinkItem[] = [
		...
		},
		{
			...
			cover: (
				<div className="bg-muted aspect-video rounded flex items-center justify-center">
					<span className="text-muted-foreground text-sm">Apps Preview</span>
				</div>
			),
			children: [
				{
