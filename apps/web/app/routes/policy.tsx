		...
		<div className="max-w-[600px] m-auto my-20 px-4">
			...
			<div className="text-component line-height-lg v-space-md">
				...
				<p className="leading-7 mt-8">
					Midday Labs AB ("us", "we", or "our") operates the Midday application (hereinafter
				...
				<p className="leading-7 mt-8">
					Midday's use of information received from Google APIs will adhere to the Google API
					Services User Data Policy, including the Limited Use requirements.
				</p>
				<p className="leading-7 mt-8">
					We do not use any data obtained from Google Workspace APIs — including Gmail data — to
					develop, improve, or train generalized artificial intelligence (AI) or machine learning
					(ML) models.
				</p>
				<p className="leading-7 mt-8">
					User data accessed via Gmail scopes is used strictly for the purpose of reading and
					extracting relevant information from emails (such as invoices and receipts) to help users
					automate and manage their business finances. This data is never shared, sold, or used for
				...
				<p className="leading-7 mt-8">
					If you are from the European Economic Area (EEA), Midday Labs AB legal basis for
				...
				<p className="leading-7 mt-8">Midday Labs AB may process your Personal Data because:</p>
				<ul>
				...
				<p className="leading-7 mt-8">
					Midday Labs AB will retain your Personal Data only for as long as is necessary for the
				...
				<p className="leading-7 mt-8">
					Midday Labs AB will also retain Usage Data for internal analysis purposes. Usage Data is
				...
				<p className="leading-7 mt-8">
					Midday Labs AB will take all the steps reasonably necessary to ensure that your data is
				...
				<p className="leading-7 mt-8">
					If Midday Labs AB is involved in a merger, acquisition or asset sale, your Personal Data
				...
				<p className="leading-7 mt-8">
					Under certain circumstances, Midday Labs AB may be required to disclose your Personal Data
				...
				<p className="leading-7 mt-8">
					Midday Labs AB may disclose your Personal Data in the good faith belief that such action
					is necessary to:
				</p>
				<ul>
				...
				<p className="leading-7 mt-8">
					...
					protection rights. Midday Labs AB aims to take reasonable steps to allow you to correct,
				...
				<ul>
					...
					<li>
						<p className="leading-7 mt-8">
							...
							a copy of the information we have on you in a structured, machine-readable and
					...
					<li>
						<p className="leading-7 mt-8">
							...
							your consent at any time where Midday Labs AB relied on your consent to process your
				...
				<ul>
					<li>
						...
						<p className="leading-7 mt-8">Firebase is analytics service provided by Google Inc.</p>
						<p className="leading-7 mt-8">
