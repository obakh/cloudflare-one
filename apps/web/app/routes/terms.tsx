		...
		<div className="max-w-[600px] m-auto my-20 px-4">
			...
			<div className="text-component line-height-lg v-space-md">
				...
				<p className="leading-7 mt-8">
					...
					the Midday application (the "Service") operated by Midday Labs AB ("us", "we", or "our").
				</p>
				...
				<p className="leading-7 mt-8">
					...
					same conditions unless you cancel it or Midday Labs AB cancels it. You may cancel your
					Subscription through your online account management page or by contacting Midday Labs AB's
					customer support.
				</p>

				<p className="leading-7 mt-8">
					A valid payment method, including a credit card, is required. You must provide accurate
					and complete billing information. By submitting payment information, you authorize us to
					charge Subscription fees to your chosen payment method.
				</p>

				<p className="leading-7 mt-8">
					If automatic billing fails, Midday Labs AB will issue an invoice and require manual
					payment within a stated deadline.
				</p>

				<h2>2. Fee Changes</h2>

				<p className="leading-7 mt-8">
					Midday Labs AB may modify Subscription fees at its sole discretion. Any changes will take
				...
				<p className="leading-7 mt-8">
					Refund requests may be considered on a case-by-case basis and are granted at the sole
				...
				<p className="leading-7 mt-8">
					...
					various information ("Content"). You are responsible for the legality, reliability, and
					appropriateness of any Content you post.
				</p>

				<p className="leading-7 mt-8">
					By posting Content, you grant us a license to use, modify, display, reproduce, and
					distribute it on the Service. You retain ownership of your Content and are responsible for
				...
				<ul className="list-disc pl-6 mt-4">
					...
					<li className="leading-7">Posting the Content does not violate any rights of others.</li>
				</ul>

				<p className="leading-7 mt-8">
					Midday Labs AB does not verify the accuracy or suitability of any financial or tax-related
					Content shared through the Service. Use of such Content is at your own risk.
				</p>
				...
				<ul className="list-disc pl-6 mt-4">
					<li className="leading-7">Belongs to someone else without authorization,</li>
				...
				<p className="leading-7 mt-8">
					Midday Labs AB is not a financial advisor, accountant, or tax consultant. All content and
				...
				<p className="leading-7 mt-8">
					Midday Labs AB accepts no liability for any consequences, losses, or penalties resulting
					from your use of the Service for financial or tax purposes.
				</p>

				<h2>7. Reliance on External Services and User-Generated Data</h2>

				<p className="leading-7 mt-8">
					Midday Labs AB relies on third-party services (e.g., banking APIs, payment providers, and
					financial aggregators) to provide transactional data and related functionality.
					Additionally, the Service may involve manually inputted or user-generated data.
				</p>

				<p className="leading-7 mt-8">You acknowledge and agree that:</p>
				<ul className="list-disc pl-6 mt-4">
					<li className="leading-7">
						All financial and transactional data—whether sourced externally or entered by users—is
						displayed "as is", without verification or warranty;
					</li>
					<li className="leading-7">
						Midday Labs AB cannot guarantee the completeness, accuracy, timeliness, or reliability
						of such data;
					</li>
					<li className="leading-7">
					...
					<li className="leading-7">
						Midday Labs AB shall not be liable for any loss, damage, or liability arising from the
						use of such data, including errors, omissions, delays, misinterpretations, or
						disruptions;
					</li>
					<li className="leading-7">
				...
				<ul className="list-disc pl-6 mt-4">
					...
					<li className="leading-7">A good-faith statement of unauthorized use.</li>
				</ul>
				...
				<p className="leading-7 mt-8">
					...
					functionality are and remain the property of Midday Labs AB and its licensors.
				</p>
				...
				<p className="leading-7 mt-8">
					...
					agree that Midday Labs AB shall not be liable for any loss or damage caused by use of such
					content or services.
				</p>
				...
				<p className="leading-7 mt-8">
					...
					terminate your account at any time by discontinuing use of the Service.
				</p>

				<h2>12. Limitation of Liability</h2>

				<p className="leading-7 mt-8">
					Midday Labs AB and its affiliates, directors, employees, and suppliers shall not be liable
				...
				<ul className="list-disc pl-6 mt-4">
					...
					<li className="leading-7">Unauthorized access or use of your Content,</li>
				...
				<p className="leading-7 mt-8">
					You use the Service at your own risk. The Service is provided on an "AS IS" and "AS
					AVAILABLE" basis, without warranties of any kind.
				</p>

				<p className="leading-7 mt-8">We do not warrant that:</p>
				<ul className="list-disc pl-6 mt-4">
					<li className="leading-7">The Service will be secure, timely, or error-free,</li>
					<li className="leading-7">Any defects will be corrected,</li>
					<li className="leading-7">The Service is free of viruses or harmful components,</li>
					<li className="leading-7">The results will meet your requirements,</li>
					<li className="leading-7">Third-party data or integrations will be reliable.</li>
				</ul>
				...
				<p className="leading-7 mt-8">
					These Terms constitute the entire agreement between you and Midday Labs AB regarding the
					Service.
				</p>
				...
				<p className="leading-7 mt-8">
					...
					be announced at least 30 days before they take effect.
				</p>
				...
				<p className="leading-7 mt-8">For questions regarding these Terms, contact:</p>
