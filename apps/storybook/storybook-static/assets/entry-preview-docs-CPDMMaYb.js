import { c as gi, d as Mr, _ as nt, b as yn, a as Z } from "./chunk-XP5HYGXS-BpfKkqn7.js";
import {
	n as Ai,
	y as Ci,
	c as Di,
...
import { R as ft, r as Ge } from "./index-DP23ewiS.js";
...
var Si = Z({
	...
	bi = Z({
		"../../node_modules/prop-types/factoryWithThrowingShims.js"(_e, t) {
			var r = Si();
			function n() {}
			function s() {}
			(s.resetWarningCache = n),
				(t.exports = () => {
					function o(_p, _m, _g, _F, _A, C) {
						if (C !== r) {
							var D = new Error(
	...
	wi = Z({
		"../../node_modules/html-tags/html-tags.json"(_e, t) {
			t.exports = [
				"a",
				"abbr",
				"address",
	...
	ki = Z({
		"../../node_modules/html-tags/index.js"(_e, t) {
			t.exports = wi();
		},
	}),
	Ii = Z({
	...
	Ti = Z({
		"../../node_modules/esutils/lib/ast.js"(_e, t) {
			(() => {
				function r(p) {
					if (p == null) return !1;
					switch (p.type) {
	...
	Fn = Z({
		"../../node_modules/esutils/lib/code.js"(_e, t) {
			(() => {
				var r, n, s, o, u, h;
				(n = {
	...
	Pi = Z({
		"../../node_modules/esutils/lib/keyword.js"(_e, t) {
			(() => {
				var r = Fn();
				function n(D) {
					switch (D) {
			...
			(o.prototype._version = 3),
				...
				(o.prototype._generateSourcesContent = function (u, h) {
					return u.map(function (p) {
						...
						return Object.hasOwn(this._sourcesContents, m) ? this._sourcesContents[m] : null;
					}, this);
				}),
	...
	Mi = Z({
		"../../node_modules/escodegen/node_modules/source-map/lib/source-map-consumer.js"(e) {
			...
			(u.fromSourceMap = (g, F) => h.fromSourceMap(g, F)),
				...
				(u.prototype._parseMappings = (_g, _F) => {
			...
			(h.prototype._parseMappings = function (g, _F) {
				for (
					var A = 1,
						C = 0,
						D = 0,
			...
			(m.prototype = Object.create(u.prototype)),
				...
				(m.prototype._parseMappings = function (_g, _F) {
	...
	Ui = Z({
		"../../node_modules/escodegen/package.json"(_e, t) {
			t.exports = {
				name: "escodegen",
...
` && (d = ["{"])),
						...
						ClassDeclaration: function (i, _l) {
							var a, c;
							return (
								(a = ["class"]),
						...
						DebuggerStatement: function (_i, l) {
							return `debugger${this.semicolon(l)}`;
						},
						EmptyStatement: (_i, _l) => ";",
							...
							return (
								ae(() => {
									(a = [`for${E}(`]),
										...
										a.push(";"),
										i.update &&
											(a.push(E), a.push(this.generateExpression(i.update, r.Sequence, R))),
										a.push(")");
								}),
...
`
						...
						FunctionDeclaration: function (i, _l) {
							return [
								at(i, !0),
								"function",
								xt(i) || pe(),
					...
					(oe.Expression = {
						...
						ArrowFunctionExpression: function (i, l, _a) {
						...
						UnaryExpression: function (i, l, _a) {
							var c, d, k, I, T;
							return (
						...
						YieldExpression: function (i, l, _a) {
							var c;
							return (
						...
						AwaitExpression: function (i, l, _a) {
							var c = W(
								i.all ? "await*" : "await",
						...
						UpdateExpression: function (i, l, _a) {
							return i.prefix
						...
						FunctionExpression: function (i, _l, _a) {
						...
						ArrayExpression: function (i, _l, _a, c) {
							var d, k;
						...
						RestElement: function (i, _l, _a) {
							return `...${this.generatePattern(i.argument)}`;
						},
						ClassExpression: function (i, _l, _a) {
							var c, d;
							return (
								(c = ["class"]),
						...
						MethodDefinition: function (i, _l, _a) {
							var c, d;
							return (
						...
						ObjectExpression: function (i, _l, _a) {
							var c, d, k;
						...
						ObjectPattern: function (i, _l, _a) {
							var c, d, k, I, T;
						...
						ThisExpression: (_i, _l, _a) => "this",
						Super: (_i, _l, _a) => "super",
						Identifier: (i, _l, _a) => Ae(i),
						ImportDefaultSpecifier: (i, _l, _a) => Ae(i.id || i.local),
						ImportNamespaceSpecifier: (i, _l, _a) => {
							var c = ["*"],
								d = i.id || i.local;
							return d && c.push(`${E}as${pe()}${Ae(d)}`), c;
						},
						ImportSpecifier: (i, _l, _a) => {
							var c = i.imported,
								d = [c.name],
								k = i.local;
							return k && k.name !== c.name && d.push(`${pe()}as${pe()}${Ae(k)}`), d;
						},
						ExportSpecifier: (i, _l, _a) => {
							var c = i.local,
								d = [c.name],
								k = i.exported;
							return k && k.name !== c.name && d.push(`${pe()}as${pe()}${Ae(k)}`), d;
						...
						ComprehensionExpression: function (i, _l, _a) {
							var c, d, k, I;
							return (
						...
						ComprehensionBlock: function (i, _l, _a) {
							var c;
							return (
						...
						SpreadElement: function (i, _l, _a) {
						...
						TemplateElement: (i, _l, _a) => i.value.raw,
						TemplateLiteral: function (i, _l, _a) {
							var c, d, k;
						...
						ImportExpression: function (i, l, _a) {
							return le(
...
`;
	...
	ts = Z({
		"../../node_modules/acorn-jsx/xhtml.js"(_e, t) {
			t.exports = {
				quot: '"',
				amp: "&",
				apos: "'",
	...
	rs = Z({
		"../../node_modules/acorn-jsx/index.js"(_e, t) {
			var r = ts(),
				n = /^[\da-fA-F]+$/,
				s = /^\d+$/,
				o = new WeakMap();
...
`
	...
	ss = Z({
		"../../node_modules/react-element-to-jsx-string/node_modules/react-is/index.js"(_e, t) {
			t.exports = is();
		},
	}),
	us = {};
...
function Rn(e) {
	...
	return (
		As(
			e,
			{
				ObjectExpression(_r, n) {
					t.push(on(n).length);
				},
				ArrayExpression(_r, n) {
					t.push(on(n).length);
				},
			},
			br,
...
function Ps(e) {
	...
	return cn(e) === !1
		...
		: ((t = e.constructor),
			t === void 0
				? !0
				: ((r = t.prototype), !(cn(r) === !1 || Object.hasOwn(r, "isPrototypeOf") === !1)));
}
var Ns = nt(ns()),
	Be = nt(ss()),
...
`)
	...
	Jn = (e, t, r, n, s) => (s ? Pe(r, n).length + t.length > s : e.length > 1),
...
var Ku = (e, t) => {
		...
		const o = { ...s, filterProps: (u, _h) => u !== void 0, ...t };
...
`)
	...
	ti = (e, t) => {
		...
		const o = e();
		if (n) return o;
		const u = { ...Zu, ...((t == null ? void 0 : t.parameters.jsx) || {}) },
			h =
