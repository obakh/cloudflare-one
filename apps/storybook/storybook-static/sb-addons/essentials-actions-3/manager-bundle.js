try {
	(() => {
		...
		var $t = "actions",
			...
			de = (e, t) => () => (t || (0, e[tt(e)[0]])((t = { exports: {} }).exports, t), t.exports),
			Kt = (e, t) => {
						...
						const u = l.split("."),
							c = (p, f, d) => {
								...
								if (d === 0) J(p, t) && (E === X || E === Xe) && c(p, X, d + 1);
									...
									for (const { name: m, data: y } of t(p)) J(y, t) && c(y, `${f}.${m}`, d + 1);
								else {
									const m = p[E];
									J(m, t) && c(m, `${f}.${E}`, d + 1);
								}
